...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.hybrid": "Hybrid Memory Routing",
  "memory.hybrid.read": "Hybrid Read Policy",
  "memory.hybrid.read.mode": "Hybrid Read Mode",
  "memory.hybrid.read.order": "Hybrid Read Order",
  "memory.hybrid.read.maxResults": "Hybrid Read Max Results",
  "memory.hybrid.read.dedupe": "Hybrid Read Dedupe",
  "memory.hybrid.write": "Hybrid Write Policy",
  "memory.hybrid.write.mode": "Hybrid Write Mode",
  "memory.hybrid.write.successPolicy": "Hybrid Write Success Policy",
  "memory.hybrid.routing": "Hybrid Routing Rules",
  "memory.hybrid.routing[].scope": "Hybrid Route Scope",
  "memory.hybrid.routing[].source": "Hybrid Route Source",
  "memory.hybrid.routing[].priority": "Hybrid Route Priority",
  "memory.hybrid.routing[].tags": "Hybrid Route Tags",
  "memory.hybrid.routing[].queryIncludes": "Hybrid Route Query Includes",
  "memory.hybrid.routing[].target": "Hybrid Route Target",
  "memory.mem0.enabled": "Mem0 Enabled",
  "memory.mem0.baseUrl": "Mem0 Base URL",
  "memory.mem0.apiKey": "Mem0 API Key", // pragma: allowlist secret
  "memory.mem0.userIdPrefix": "Mem0 User ID Prefix",
  "memory.mem0.agentIdPrefix": "Mem0 Agent ID Prefix",
  "memory.mem0.searchPath": "Mem0 Search Path",
  "memory.mem0.addPath": "Mem0 Add Path",
  "memory.mem0.topK": "Mem0 Top K",
  "memory.mem0.threshold": "Mem0 Score Threshold",
  "memory.mem0.timeoutMs": "Mem0 Timeout (ms)",
